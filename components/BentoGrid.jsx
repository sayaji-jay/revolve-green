...
export default function SustainabilityBento() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50 py-8 md:py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto" ref={containerRef}>
        
        {/* Header */}
        <div className="text-center mb-8 md:mb-12 card-animate">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-emerald-800 mb-3">
            SUSTAINABILITY
            <span className="block text-2xl md:text-3xl lg:text-4xl text-emerald-600 mt-2">with purpose</span>
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 auto-rows-auto">
          ...
          {/* Card 2 - Our Idea */}
          <div className="card-animate bg-gradient-to-br from-lime-400 to-lime-500 rounded-3xl p-5 md:p-6 md:col-span-2 flex flex-col overflow-hidden relative group hover:shadow-xl transition-shadow duration-300 min-h-[280px]">
          ...
          <div className="card-animate bg-gradient-to-br from-lime-400 to-lime-500 rounded-3xl p-5 md:p-6 hover:scale-105 transition-transform duration-300">
